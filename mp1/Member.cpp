 ...
 * Constructor
 */
MemberListEntry::MemberListEntry(int id, short port, long heartbeat,
                                 long timestamp)
 ...
 * DESCRIPTION: setter
 */
void MemberListEntry::setid(int id) { this->id = id; }
 ...
 * DESCRIPTION: setter
 */
void MemberListEntry::setport(short port) { this->port = port; }
