 ...
 */
size_t Node::getHashCode() { return nodeHashCode; }
 ...
 */
Address* Node::getAddress() { return &nodeAddress; }
 ...
 */
void Node::setHashCode(size_t hashCode) { this->nodeHashCode = hashCode; }
 ...
 */
void Node::setAddress(Address address) { this->nodeAddress = address; }
